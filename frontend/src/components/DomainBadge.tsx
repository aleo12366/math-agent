...
const DOMAIN_COLORS: Record<string, string> = {
  '代数': 'badge-green', '微积分': 'badge-blue', '线性代数': 'badge-purple',
  '概率统计': 'badge-green', '偏微分方程': 'badge-yellow', '微分方程': 'badge-yellow',
  '复分析': 'badge-blue', '拓扑': 'badge-purple', '运筹学': 'badge-green',
  '数论': 'badge-yellow', '组合数学': 'badge-blue', '实分析': 'badge-purple',
  '抽象代数': 'badge-green', '微分几何': 'badge-yellow', '泛函分析': 'badge-blue',
  '数值分析': 'badge-purple', '离散数学': 'badge-green', '优化': 'badge-yellow',
  '信息论': 'badge-blue', '随机过程': 'badge-purple', '几何': 'badge-green',
  '数学物理': 'badge-yellow', '未知': 'badge-blue',
};
